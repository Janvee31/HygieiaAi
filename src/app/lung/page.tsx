    ...
    <div className="min-h-screen">
      ...
      >
        <motion.div variants={itemVariants} className="mb-8 text-center">
          <h1 className="text-4xl font-bold mb-4 text-bold bg-clip-text text-transparent bg-white">
        ...
        <AnimatePresence mode="wait">
          ...
          {prediction && (
            <motion.div
              variants={itemVariants}
              className="mt-6 p-6 rounded-xl border border-white/15 text-white shadow-2xl"
              style={{
                background: `linear-gradient(135deg, rgba(8, 13, 24, 0.88), ${theme}33)`,
                backdropFilter: 'blur(10px)',
              }}
            >
              <h3 className="text-2xl font-semibold mb-4 text-center text-white">Prediction Result</h3>
